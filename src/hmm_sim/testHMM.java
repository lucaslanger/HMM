...
public class testHMM extends Environment{
	...
	public static void main(String[] args){
		testHMM h = testHMM.make2StateHMM();
	}
	
	public testHMM(String description, Matrix T, Matrix O, Matrix P, Matrix E, int desiredHankelSize){
	...
	public static testHMM make2StateHMM(){
		double[][] p = { {1}, {0}};
		...
		int hSize = 100;
		testHMM h = new testHMM("2_State_HMM",T,O,P,E,hSize);	
		return h;
	}
	
	public static testHMM makeLabyrinth(int loop1, int loop2 , double selfTransitionP, int hSize){
		boolean debug = false;
		...
		testHMM l = new testHMM(d, T, O, P, E, hSize);
